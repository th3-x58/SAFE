...
export const GoalsIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 3.625c.356.356.586.838.586 1.375 0 .537-.23 1.019-.586 1.375M5.625 3.625a1.95 1.95 0 012.757 0c.356.356.586.838.586 1.375 0 .537-.23 1.019-.586 1.375M12 3v9" />
  </svg>
);
...
export const FinancialOutlineIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
